#!/bin/bash
This file conatins details of the task to be done on C - variables, if, else, while and they are listed below.
...
k 2 - Write a program that prints the alphabet in lowercase, followed by a new line.
